...
bool InitResourceDX10(void)
{
	...
	const char *shader = "../../shaders/vertexcolor_texture_dx10.hlsl";
	// 載入讀取兩張貼圖的Shader
	{
	...
	// 載入兩張貼圖
	{
		...
		if ( NULL==g_pTexture[0] )
			return false;
		g_pTexture[1] = GutLoadTexture_DX10("../../textures/lena.tga");
	...
	{
		// vertex buffer
		cbDesc.ByteWidth = sizeof(Vertex_VCT) * 4;
