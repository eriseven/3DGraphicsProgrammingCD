...
void main(int argc, char *argv[])
{
	...
	printf("(2) strawberry\n");
	printf("(3) tower\n");
	printf("(4) grumman j2f\n");

	char *model = "../../models/box_brick.gma";
	char *texture_path = "../../textures/";
	...
	{
	case '1':
		model = "../../models/teapot.gma";
		break;
	case '2':
		model = "../../models/strawberry/strawberry.gma";
		texture_path = "../../models/strawberry/";
		break;
	case '3':
		model = "../../models/tower/tower.gma";
		texture_path = "../../models/tower/";
		break;
	case '4':
		model = "../../models/j2f/j2f.gma";
		texture_path = "../../models/j2f/";
		break;
	default:
		if ( argc > 1 )
		{
	...
	CGutModel::SetTexturePath(texture_path);
