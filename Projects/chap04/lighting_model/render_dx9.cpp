...
void SetupLightingDX9(void)
{
	...
	Vector4 LightDir = -g_Light0.m_Direction;

	light.Direction = *(D3DVECTOR *) &LightDir;
	light.Diffuse = *(D3DCOLORVALUE*) &g_Light0.m_Diffuse;
	light.Specular = *(D3DCOLORVALUE*) &g_Light0.m_Specular;
	light.Ambient = *(D3DCOLORVALUE*) &g_Light0.m_Ambient;
	light.Range = 1000.0f;
	...
	LightDir = -g_Light1.m_Direction;
	light.Direction = *(D3DVECTOR *) &LightDir;
	light.Diffuse = *(D3DCOLORVALUE*) &g_Light1.m_Diffuse;
	light.Specular = *(D3DCOLORVALUE*) &g_Light1.m_Specular;
	light.Ambient = *(D3DCOLORVALUE*) &g_Light1.m_Ambient;
