...
bool InitResourceDX10(void)
{
	...
	// vertex buffer
    cbDesc.ByteWidth = sizeof(Vertex_VCN) * g_iMaxNumGridVertices;
	...
	g_Simulation.m_ViewMatrix = GutMatrixLookAtRH(g_eye, g_lookat, g_up);
	g_Simulation.m_WorldViewMatrix = g_Simulation.m_WorldMatrix * g_Simulation.m_ViewMatrix;
...
void RenderFrameDX10(void)
{
	...
	// 計算矩陣
	Matrix4x4 world_view_proj_matrix = g_Simulation.m_WorldViewMatrix * g_proj_matrix;
	// 設定shader參數
