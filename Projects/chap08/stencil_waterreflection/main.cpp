...
void main(void)
{
	...
	GutInputInit();
	GutRegisterKeyDown(GUTKEY_C, KeyDown_C);
	GutRegisterKeyDown(GUTKEY_1, KeyDown_C);

	g_Control.SetCamera(Vector4(0.0f, 5.0f, 1.0f), Vector4(0.0f), Vector4(0.0f, 0.0f, 1.0f) );
